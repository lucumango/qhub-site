    ...
    <div className="relative bg-purple-50 border border-purple-200 rounded-2xl shadow-lg p-8 text-center transition-all duration-500 min-h-[480px] flex flex-col justify-center items-center">
      ...
      {step === "intro" && (
        <div className="animate-fade-in-up">
          ...
          <p className="text-lg text-gray-700 mb-6 font-flatory max-w-md mx-auto">
            Schrödi te acompañará mientras respondes preguntas sobre superposición.  
            Algunas requieren pensar como un verdadero físico 🧮✨
          </p>
          <button
            onClick={() => setStep("quiz")}
            className="px-6 py-3 bg-quantum-purple text-white text-lg rounded-full font-semibold hover:bg-quantum-orange transition-all shadow-md hover:shadow-[0_0_25px_rgba(168,85,247,0.5)]"
          >
            Comenzar 🧠
          </button>
        </div>
      ...
      {step === "results" && (
        <div className="animate-fade-in-up">
          ...
          <button
            ...
            className="px-6 py-3 bg-quantum-orange text-lg text-white rounded-full font-semibold hover:bg-orange-600 transition-all shadow-md hover:shadow-[0_0_25px_rgba(249,115,22,0.4)]"
          >
            Intentar de nuevo 🔁
          </button>
        </div>
