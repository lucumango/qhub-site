            ...
            <div className="hidden md:flex items-center space-x-8">
              {navigation.map((item) => (
                <Link
                  key={item.name}
                  to={item.href}
                  className={`px-3 py-2 text-sm font-medium transition-colors hover-quantum ${isActivePath(item.href)
              ...
              <Button
                asChild
                variant="ghost"
                className="text-white hover:text-quantum-orange"
              >
              ...
              <div className="px-2 pt-2 pb-3 space-y-1">
                {navigation.map((item) => (
                  <Link
                    ...
                    className={`block px-3 py-2 text-base font-medium transition-colors ${isActivePath(item.href)
                ...
                <div className="px-3 py-2">
                  <Button
                    asChild
                    variant="ghost"
                    className="text-white hover:text-quantum-orange w-full justify-start"
                  >
